...
export default function FusionTrainer() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-4">
      ...
      <p className="text-xs" style={{color:"var(--text-muted)"}}>Not in sidebar — URL only. Trains fusion (sensor + visual + EAR → pass/near/over). Needs 50+ deployment logs with paired sensor+visual; else will error transparently.</p>
      ...
      <div className="text-xs" style={{color:"var(--text-muted)"}}>If error about not enough paired data, collect via Live Flow first — fusion needs paired sensor+visual logs.</div>
    </div>
  );
}
